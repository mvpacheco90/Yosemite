...
\def\corrAuthor{Greg M.~Stock (Geomorphology): greg\_stock@nps.gov, \\Dylan H.~Rood (Geochronology): d.rood@imperial.ac.uk}
\def\corrEmail{Alain M.~Plattner (Geophysics): amplattner@ua.edu}
