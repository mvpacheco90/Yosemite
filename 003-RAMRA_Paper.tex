...
We collected eight Ground Penetrating Radar
    ...
    (Fig.~\ref{GPR_ERT_MapT} A and B), covering both exposed parts of the rock
...
Resistive material appears overlaying relatively conductive material beyond the area mapped as the exposed portion of the rock avalanche (begning of profiles E2, E3, and E4  (Fig.~\ref{GPR_ERT_MapT}B)). 
